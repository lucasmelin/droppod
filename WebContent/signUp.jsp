		...
		<form class="" action="signupServlet" method="post">
			...
			<div class="form-group">
				...
				<input class="form-control" type="text" name="username"
					...
					name="email" id="email"
					placeholder="<fmt:message key="signup.email" />" required /> <input
					class="form-control" type="text" name="city" id="city"
					placeholder="<fmt:message key="signup.city" />" required /> <input
					class="form-control" type="text" name="country" id="country"
					placeholder="<fmt:message key="signup.country" />" required /> <input
