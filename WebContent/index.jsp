		...
		<form class="" action="loginServlet" method="post">
			...
			<div class="form-group">
				...
				<input class="form-control" type="text" name="username"
					id="username" placeholder="<fmt:message key="index.userid" />"
					required autofocus /> <input class="form-control" type="password"
					name="password" id="password"
					placeholder="<fmt:message key="index.password" />" required />
			</div>
			<input type="submit" class="btn btn-dark btn-lg btn-block mb-3"
				value="<fmt:message key="index.login"/>" />
		</form>
