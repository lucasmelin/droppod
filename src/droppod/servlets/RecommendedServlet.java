  ...
  private static final long serialVersionUID = 6614114375578034226L;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) {
      ...
      try {
          ...
          pst = conn.prepareStatement("SELECT ps1.podcast_id as podcast_id1, ps2.podcast_id as podcast_id2, count(ps1.user_id) AS Overlap, pt1.podcast_name AS podcast_name1, pt2.podcast_name AS podcast_name2\r\n" + 
