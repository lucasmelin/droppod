  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      pst1 = con.prepareStatement(
          "SELECT users.city_id, users.country_id, cities.name, languages.code\r\n"
              + "from droppod.users\r\n"
      ...
      pst = con.prepareStatement(
          "SELECT p.id, COUNT(s.user_id) AS numusers, pt.podcast_name, pt.podcast_description, p.rating, p.url, p.thumbnail_url, p.uuid\r\n"
