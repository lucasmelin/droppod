  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      pst2 = con.prepareStatement(
          "DELETE FROM droppod.subscriptions WHERE podcast_id IN (SELECT id FROM droppod.podcasts where uuid =?) AND user_id = ?");
      ...
      if (pst2.executeUpdate() == 1) {
        ...
        // Iterate through session podcast UUIDS to remove the podcast that has been removed from the users subscription list
        ...
        // Print out new list of podcast UUIDs
