...
public class FollowPodcastServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    // Retrieve session variables for queries
    ...
    try {
      ...
      pst2 = con.prepareStatement(
          "INSERT IGNORE INTO droppod.subscriptions (podcast_id, user_id) VALUES (?, ?)");
      pst2.setInt(1, podcastID);
      pst2.setInt(2, userID);

      if (pst2.executeUpdate() == 1) {
    	  
    	// If query executes without error, update the session variable to include the new podcast(s)
      ...
      // Once the podcast has been followed, redirect user to the Follow page
